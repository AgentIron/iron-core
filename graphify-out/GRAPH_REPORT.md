...
## Corpus Check
- 213 files · ~189,527 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3728 nodes · 5886 edges · 251 communities (217 shown, 34 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 345 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7b7a7f68`
...
- `test_session_tool_catalog_cache_invalidates_on_mcp_registry_change()` --calls--> `ConnectionId`  [INFERRED]
  tests/mcp_integration_tests.rs → src/runtime.rs
- `test_session_tool_catalog_filters_consistently()` --calls--> `ConnectionId`  [INFERRED]
  tests/mcp_integration_tests.rs → src/runtime.rs
- `test_mcp_unavailable_tool_diagnostics_disabled_server()` --calls--> `ConnectionId`  [INFERRED]
  tests/mcp_integration_tests.rs → src/runtime.rs
- `test_mcp_unavailable_tool_diagnostics_unknown_tool()` --calls--> `ConnectionId`  [INFERRED]
  tests/mcp_integration_tests.rs → src/runtime.rs
- `test_mcp_unavailable_tool_diagnostics_unconfigured_server()` --calls--> `ConnectionId`  [INFERRED]
  tests/mcp_integration_tests.rs → src/runtime.rs
...
Cohesion: 0.05
Nodes (22): ActivePrompt, additional_skill_dirs_are_loaded_as_trusted_user_scope(), CachedSessionToolCatalog, disconnect_provider_oauth_removes_oauth_only(), IronRuntime, make_skill(), new_with_credential_store_creates_resolver(), provider_auth_status_api_key() (+14 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (25): alias_for_tool(), alias_generation_omits_reserved_and_colliding_names(), alias_generation_sanitizes_names(), ToolCatalog, ToolCatalogEntry, PythonExecTool, script_output_to_json(), RuntimeError (+17 more)
...
Cohesion: 0.08
Nodes (46): McpConnectionManager, McpTool Legacy Type, SessionToolCatalog, Close MCP Correctness Gaps (Change), HTTP+SSE MCP Transport, build_catalog(), build_catalog_with_local_tools(), build_catalog_with_plugins() (+38 more)
...
Cohesion: 0.07
Nodes (27): AcpSupport, create_in_process_transport(), create_stdio_agent(), InProcessClient, InProcessClientHandler, InProcessTransport, LocalClientChannel, LocalClientChannel<H> (+19 more)
...
Cohesion: 0.1
Nodes (24): clone_independent_lifecycle(), clone_shares_state(), debug_impl_works(), default_constructor_applies_default_memory_ceiling(), execute_tool_on_empty_plugin_returns_execution_failed(), execute_tool_on_unloaded_plugin_returns_not_found(), execute_tool_sync_on_unloaded_plugin_returns_not_found(), get_plugin_manifest_initially_none() (+16 more)

### Community 17 - "Community 17"
Cohesion: 0.08
Nodes (16): build_inference_request(), keep_recent_parity_between_legacy_and_acp(), client_editing_guidance_overrides_fallback_without_overriding_core(), client_injection_fragments_render_in_order(), prompt_preserves_repo_and_session_content_inside_client_injection(), prompt_section_ordering_is_fixed(), provider_guidance_only_appears_in_provider_section(), provider_name_overrides_manual_provider_guidance() (+8 more)
...
Cohesion: 0.1
Nodes (30): arbitrary_code_bearing_payload_is_rejected(), empty_transcript_text_is_rejected(), empty_view_id_is_rejected(), looks_like_rich_result_candidate(), non_rich_json_with_transcript_key_is_left_untouched(), normalize_plugin_tool_result(), normalized_value(), plain_json_result_is_left_untouched() (+22 more)

### Community 25 - "Community 25"
Cohesion: 0.14
Nodes (24): concurrent_sse_requests_are_correctly_correlated(), connection_manager_stops_on_shutdown_signal(), FakeSseServer, http_sse_transport_handles_framing_and_response_correlation(), mcp_name_resolution_is_unambiguous_for_server_ids_with_underscores(), public_effective_tools_match_prompt_visible_tools(), read_http_request(), RecordingProvider (+16 more)

### Community 26 - "Community 26"
Cohesion: 0.1
Nodes (16): PromptAssembler, PromptSectionMetadata, PromptSectionOwner, PromptSectionTemperature, push_part(), render_client_injection(), render_communication_formatting(), render_core_guidelines() (+8 more)
...
Cohesion: 0.11
Nodes (8): crate::error::RuntimeError, EditTool, execute_read(), is_binary(), MultieditTool, ReadTool, render_directory_listing(), WriteTool
...
Cohesion: 0.08
Nodes (7): AuthFailProvider, MockProvider, TestProvider, TestProvider, MockProvider, MockProvider, TestProvider
...
Cohesion: 0.09
Nodes (16): CompactionCheckpoint, CompactionEngine, CompactionInput, CompactionReason, CompressRange, CompressResult, extract_json_object(), older_provider_messages() (+8 more)
...
Cohesion: 0.18
Nodes (8): BuiltinToolError, execute_edit(), execute_multiedit(), execute_write(), resolve_write_path(), validate_no_path_conflict(), read_to_string(), builtin_error_code_to_json()
...
Cohesion: 0.11
Nodes (19): ConnectionId, cancel_active_prompt_signals_cancellation(), close_session_removes_only_that_session(), closing_connection_removes_its_sessions(), create_session_on_shutdown_errors(), has_active_prompt_reflects_prompt_lifecycle(), runtime_allows_prompt_after_previous_finishes(), runtime_creates_connection_and_session() (+11 more)
...
Cohesion: 0.12
Nodes (15): CompactedContext Struct, ContextWindowPolicy, Compacted Context + Retained Tail Prompt Model, ActiveContextAccountant, ActiveContextSnapshot, ContextCategory, ContextCategoryUsage, ContextQuality (+7 more)
...
Cohesion: 0.14
Nodes (7): bytes_to_pages(), explicit_memory_ceiling_is_stored(), load_plugin_with_limit_applies_smaller_of_two(), sample_manifest(), set_and_get_manifest_round_trip(), set_manifest_on_nonexistent_plugin_is_noop(), WasmHost
...
Cohesion: 0.18
Nodes (13): estimate_structured_tokens(), compaction_prepare_extracts_tail_and_builds_prompt(), compaction_prepare_includes_historical_tool_transcript(), compaction_prepare_with_existing_context_includes_previous(), compaction_split_session_messages_rule(), compaction_split_session_policy_rule(), compaction_split_session_small_session(), compaction_split_session_tokens_rule() (+5 more)
...
Cohesion: 0.14
Nodes (4): ApprovalStrategy, ConfigSource, ContextWindowPolicy, EmbeddedPythonConfig
...
Cohesion: 0.17
Nodes (11): ADDED Requirements, Requirement: Critical pressure failure is visible to the user, Requirement: Pressure clears only after recomputed usage is below threshold, Requirement: Slash compact runs an immediate compression turn, Requirement: Visible context IDs address compressible context, Scenario: Compressed blocks include block IDs, Scenario: Compression cannot resolve critical pressure, Scenario: Provider-visible transcript includes timeline IDs (+3 more)
...
Cohesion: 0.35
Nodes (10): apply_context_window_policy(), build_composed_instructions(), build_inference_request_with_context(), build_inference_request_with_context_and_repo(), build_inference_request_with_effective_tools(), build_inference_request_with_repo(), compacted_context_message(), EffectiveToolRequestContext (+2 more)
...
Cohesion: 0.24
Nodes (4): RepoInstructionLoader, resolve_scope(), additional_files_error_on_missing(), additional_files_loaded_into_payload()
...
Cohesion: 0.28
Nodes (8): Bootstrap-Only ID Tolerance, Fix MCP CamelCase Protocol Fields Change, Handoff Portability Model, MCP Protocol Structs, MCP Server Inventory, Handle Missing MCP Response ID Change, serde rename_all camelCase, Session-Scoped MCP Support Capability
...
Cohesion: 0.36
Nodes (8): Close MCP Correctness Gaps - Session Scoped MCP Support Spec, HttpMcpClient, HttpSseMcpClient, HttpConfig Struct, mcp-http-headers Capability, MCP HTTP Headers Change, McpTransport Enum, MCP Transport Types (stdio, HTTP, HTTP+SSE)
...
Cohesion: 0.29
Nodes (7): Extism WASM Runtime, iron_manifest WASM Custom Section, PluginLifecycle, PluginLoader Trait, PluginRegistry, tool_{name} Plugin Entrypoint, WasmHost Extism Adapter

### Community 154 - "Community 154"
Cohesion: 0.29
Nodes (6): PromptSection, test_end_to_end_mcp_lifecycle(), test_mcp_tools_have_namespaced_names(), stdio_call_tool_preserves_server_error_details_and_correlates_responses(), stdio_transport_applies_working_dir_and_uses_safe_environment(), write_review_stdio_mcp_server()
...
Cohesion: 0.33
Nodes (6): Finish MCP Outstanding Work - Tasks, src/mcp/client.rs, src/mcp/connection.rs, src/mcp/effective_tools.rs, src/mcp/session_catalog.rs, src/runtime.rs
...
## Knowledge Gaps
- **1086 isolated node(s):** `Run the build and lint checks with a terse summary.`, `Run the test suite with a terse summary.`, `Run security checks with a terse summary.`, `CapabilityDescriptor`, `CapabilityBackend` (+1081 more)
...
- **Why does `iron-providers Dependency` connect `Community 99` to `Community 0`, `Community 2`, `Community 9`, `Community 106`, `Community 10`, `Community 76`, `Community 41`, `Community 46`, `Community 143`, `Community 53`, `Community 86`, `Community 25`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `compute_tool_availability` connect `Community 59` to `Community 3`, `Community 5`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `SessionToolCatalog` connect `Community 59` to `Community 153`, `Community 198`?**
