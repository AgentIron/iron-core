...
## Corpus Check
- 209 files · ~186,607 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3626 nodes · 5744 edges · 237 communities (201 shown, 36 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 343 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5daa932e`
...
Cohesion: 0.06
Nodes (73): codex_expires_at_to_secs(), codex_test_metadata(), CodexAuthorizationResponse, CodexDeviceAuthState, decode_base64_url(), device_code_response_parsing(), DeviceCodeInteraction, DeviceCodeResponse (+65 more)
...
Cohesion: 0.07
Nodes (40): create_transport_client(), ConnectionId, cancel_active_prompt_signals_cancellation(), close_session_removes_only_that_session(), closing_connection_removes_its_sessions(), create_session_on_shutdown_errors(), has_active_prompt_reflects_prompt_lifecycle(), runtime_allows_prompt_after_previous_finishes() (+32 more)
...
Cohesion: 0.14
Nodes (13): BuiltinToolError, execute_edit(), execute_multiedit(), execute_read(), execute_write(), is_binary(), render_directory_listing(), resolve_write_path() (+5 more)
...
Cohesion: 0.14
Nodes (20): compaction_execute_calls_provider_and_parses_result(), compaction_execute_handles_empty_output(), compaction_execute_handles_malformed_json(), compaction_execute_handles_provider_error(), compaction_prepare_extracts_tail_and_builds_prompt(), compaction_prepare_includes_historical_tool_transcript(), compaction_prepare_with_existing_context_includes_previous(), facade_checkpoint_rejects_disabled_context_management() (+12 more)
...
Cohesion: 0.13
Nodes (8): ChildCallOutcome, ChildCallStatus, ScriptError, ScriptErrorKind, ScriptExecStatus, ScriptInput, ScriptOutput, ScriptResult
...
Cohesion: 0.23
Nodes (16): compute_tool_availability, EffectiveToolView, Embedded Python Runtime, Finish MCP Outstanding Work - Design, Finish MCP Outstanding Work - Python Tool Namespace Spec, Finish MCP Outstanding Work - Session Scoped MCP Support Spec, Fully Operational MCP - Design, Fully Operational MCP - Python Tool Namespace Spec (+8 more)
...
Cohesion: 0.17
Nodes (3): SessionId, TimelineEntry, ToolRecordStatus
...
Cohesion: 0.23
Nodes (6): render_directory_entries(), render_path(), render_skip_warning(), render_truncation_footer(), render_glob_output(), render_grep_output()
...
Cohesion: 0.24
Nodes (10): compaction_split_session_messages_rule(), compaction_split_session_policy_rule(), compaction_split_session_small_session(), compaction_split_session_tokens_rule(), durable_session_apply_compaction_resets_uncompacted_tokens(), handoff_bundle_serialization_round_trip(), handoff_export_idle_session_succeeds(), handoff_export_includes_provenance() (+2 more)
...
Cohesion: 0.22
Nodes (11): ApprovalStrategy, Finish MCP Outstanding Work - Proposal, Fully Operational MCP - Proposal, Fully Implement MCP and WASM Plugins Change, python-tool-namespace capability, session-scoped-mcp-support capability, wasm-integration-plugins Capability, WASM Integration Plugins - Design (+3 more)

### Community 119 - "Community 119"
Cohesion: 0.2
Nodes (9): Dependency Version Guidance Capability, Dynamic System Prompt Templating, iron-providers Dependency, monty Git Dependency, Monty Embedded Python Runtime, Nine-Section System Prompt Model, Prompt Invalidation and Caching, Section Ownership Model (+1 more)
...
Cohesion: 0.22
Nodes (8): Purpose, Requirement: MCP integration must not regress local tool execution, Requirement: Public MCP helper APIs must not advertise stub execution behavior, Requirements, Scenario: Local tool remains executable after MCP integration, Scenario: MCP lookup remains unambiguous for provider-visible names, Scenario: Public MCP helper cannot report fake execution success, session-scoped-mcp-support Specification
...
Cohesion: 0.33
Nodes (3): ApprovalStrategy, ConfigSource, ContextWindowPolicy
...
- **Why does `iron-providers Dependency` connect `Community 119` to `Community 0`, `Community 5`, `Community 6`, `Community 7`, `Community 101`, `Community 10`, `Community 75`, `Community 76`, `Community 18`, `Community 181`, `Community 118`, `Community 57`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `SessionToolCatalog` connect `Community 83` to `Community 117`, `Community 94`, `Community 14`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `compute_tool_availability` connect `Community 83` to `Community 1`, `Community 3`?**
