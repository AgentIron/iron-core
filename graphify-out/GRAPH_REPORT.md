# Graph Report - iron-core  (2026-05-19)

## Corpus Check
- 209 files · ~186,565 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3626 nodes · 5742 edges · 242 communities (201 shown, 41 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 342 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `494cf18f`
...
3. `AgentSession` - 48 edges
4. `DurableSession` - 40 edges
5. `temp_config()` - 33 edges
6. `IronAgent` - 30 edges
7. `ConnectionId` - 30 edges
...
- `unit_schema_validate_valid()` --calls--> `validate_arguments()`  [INFERRED]
  tests/acp_runtime_tests.rs → src/schema.rs
- `unit_schema_validate_invalid()` --calls--> `validate_arguments()`  [INFERRED]
  tests/acp_runtime_tests.rs → src/schema.rs
...
- **Context Compaction Model: compacted context + retained tail replaces transcript reconstruction** — context_management, CompactedContext, destructive_compaction, compacted_context_retained_tail [EXTRACTED 1.00]
- **MCP Transport Layer: stdio and HTTP+SSE transports managed by McpConnectionManager** — stdio_transport, httpsse_transport, McpConnectionManager, McpTool, SessionToolCatalog [EXTRACTED 1.00]
- **MCP Operational Changes Trilogy** — fully_operational_mcp_design, finish_mcp_outstanding_work_design, close_mcp_correctness_gaps_session_scoped_mcp_support_spec [INFERRED 0.85]
- **Session-Effective Tool Surface Architecture** — session_tool_catalog, tool_registry, mcp_connection_manager [EXTRACTED 0.90]
- **Streaming Multimodal Prompt Flow** — agent_session, content_block, prompt_stream_with_blocks [EXTRACTED 0.95]
- **Three Changes Modifying session-scoped-mcp-support Capability** — mcp_http_headers_change, camelcase_fix_change, missing_response_id_change [EXTRACTED 1.00]
- **WASM Plugin Runtime Stack** — plugin_lifecycle, plugin_registry, wasm_host [EXTRACTED 1.00]
- **Canonical Session-Effective Tool Surface** — session_tool_catalog, approval_strategy, compute_tool_availability [EXTRACTED 1.00]
- **Plugin Interaction Layer (choice, rich output, auth)** — support_model_choice_prompts, support_rich_wasm_plugin_output, support_runtime_auth_interactions [INFERRED 0.75]
- **MCP Transport Changes Modifying Session-Scoped MCP Support** — handle_missing_mcp_response_id, hybrid_stdio_env_sanitization, session_scoped_mcp_stdio_spec [EXTRACTED 1.00]
- **Built-in Tool Efficiency Change Stack** — ripgrep_ecosystem_integration, shared_tool_result_renderer, multiedit_capability [EXTRACTED 1.00]
- **Session-Effective Tool Surface Participants** — session_effective_tool_catalog, session_scoped_mcp_support, wasm_integration_plugins, python_tool_namespace [EXTRACTED 0.90]
- **Prompt Composition Architecture** — dynamic_system_prompt_templating, agent_skills, context_compaction [INFERRED 0.80]
- **Plugin Tool Execution Lifecycle** — wasm_integration_plugins, plugin_rich_output, runtime_auth_interactions [EXTRACTED 0.85]
- **SessionToolCatalog Unifies Three Tool Sources** — plugins_session_tool_catalog, arch_tool_architecture, plugins_tool_availability [EXTRACTED 0.95]
...
Cohesion: 0.05
Nodes (66): SchemaValidationOutcome, validate_arguments(), activate_skill_duplicate_activation_returns_lightweight_confirmation(), activate_skill_rejects_names_outside_session_catalog(), activate_skill_returns_structured_content_and_resources(), agent_session_cancel_signals_cancellation(), approval_strategy_always_triggers_for_all_tools(), approval_strategy_never_skips_even_for_approval_tools() (+58 more)
...
Cohesion: 0.08
Nodes (38): build_wasm_with_manifest_section(), cached_artifact_path_basic(), cached_artifact_path_sanitises_dotdot(), cached_artifact_path_sanitises_slashes(), encode_leb128(), extract_manifest_from_valid_wasm(), extract_manifest_from_wasm_without_section(), extract_manifest_rejects_bad_json() (+30 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (45): McpConnectionManager, McpTool Legacy Type, SessionToolCatalog, Close MCP Correctness Gaps (Change), HTTP+SSE MCP Transport, build_catalog(), build_catalog_with_local_tools(), build_catalog_with_plugins() (+37 more)
...
Cohesion: 0.05
Nodes (31): RepoInstructionLoader, resolve_scope(), apply_context_window_policy(), build_composed_instructions(), build_inference_request(), build_inference_request_with_context(), build_inference_request_with_context_and_repo(), build_inference_request_with_effective_tools() (+23 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (18): PythonExecTool, script_output_to_json(), agent_text(), limit_result_size(), make_session_and_ephemeral(), managed_does_not_retry_api_key_backed_auth_failure(), managed_does_not_retry_stream_auth_failure_after_output(), managed_no_retry_on_transport_error() (+10 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (50): ADDED Requirements, MODIFIED Requirements, Purpose, Requirement: Auth-mediated plugin availability SHALL be directly understandable to clients, Requirement: Client-visible plugin inspection and session control APIs, Requirement: Effective plugin tool exposure depends on enablement, health, and auth availability, Requirement: Plugin-backed tool calls complete through the runtime with normalized client-visible rich results, Requirement: Plugin-backed tool calls reuse the standard runtime execution lifecycle (+42 more)
...
Cohesion: 0.08
Nodes (34): edit_replace_all_fails_on_zero_matches(), edit_replace_all_replaces_every_occurrence(), edit_requires_prior_read(), edit_tool_applies_exact_replacement(), edit_tool_rejects_ambiguous_match(), edit_tool_rejects_missing_text(), glob_explicit_hidden_pattern_overrides_default_filters(), glob_output_is_compact_paths() (+26 more)
...
Cohesion: 0.06
Nodes (7): telemetry_empty_session_reports_unknown_quality(), telemetry_totals_match_category_sum(), telemetry_with_compacted_context_counts_category(), telemetry_with_current_prompt_counts_prompt_category(), telemetry_with_instructions_counts_category(), telemetry_with_messages_counts_tail_category(), telemetry_with_tools_counts_tool_definitions_category()
...
Cohesion: 0.1
Nodes (17): PromptAssembler, PromptSection, PromptSectionMetadata, PromptSectionOwner, PromptSectionTemperature, push_part(), render_client_injection(), render_communication_formatting() (+9 more)

### Community 24 - "Community 24"
Cohesion: 0.12
Nodes (17): allows_private_when_opted_in(), check_ip(), execute_webfetch(), is_blocked_ip(), is_blocked_v4(), is_blocked_v6(), is_v4_cgnat(), is_v4_documentation() (+9 more)

### Community 25 - "Community 25"
Cohesion: 0.14
Nodes (12): BuiltinToolError, execute_edit(), execute_multiedit(), execute_read(), execute_write(), is_binary(), render_directory_listing(), resolve_write_path() (+4 more)
...
Cohesion: 0.09
Nodes (13): decode_http_rpc_response(), format_stderr_suffix(), is_sensitive_env_var(), McpTransportClient, parse_sse_rpc_response(), push_stderr_excerpt(), sanitize_stderr_line(), sanitized_env_preserves_non_sensitive_vars() (+5 more)

### Community 31 - "Community 31"
Cohesion: 0.16
Nodes (21): concurrent_sse_requests_are_correctly_correlated(), connection_manager_stops_on_shutdown_signal(), FakeSseServer, http_sse_transport_handles_framing_and_response_correlation(), mcp_name_resolution_is_unambiguous_for_server_ids_with_underscores(), public_effective_tools_match_prompt_visible_tools(), read_http_request(), RecordingProvider (+13 more)
...
Cohesion: 0.17
Nodes (18): ActivePrompt, CachedSessionToolCatalog, disconnect_provider_oauth_removes_oauth_only(), new_with_credential_store_creates_resolver(), provider_auth_status_api_key(), provider_auth_status_for_context_reports_unsupported_api_key(), provider_auth_status_for_context_uses_api_key(), provider_auth_status_not_configured() (+10 more)

### Community 34 - "Community 34"
Cohesion: 0.08
Nodes (25): ConnectionId, cancel_active_prompt_signals_cancellation(), close_session_removes_only_that_session(), closing_connection_removes_its_sessions(), create_session_on_shutdown_errors(), has_active_prompt_reflects_prompt_lifecycle(), runtime_allows_prompt_after_previous_finishes(), runtime_creates_connection_and_session() (+17 more)
...
Cohesion: 0.1
Nodes (23): ADDED Requirements, context-compaction Specification, MODIFIED Requirements, Purpose, Requirement: Compacted context SHALL preserve activated skill instructions, Requirement: Compaction behavior is verified end to end, Requirement: Compaction prunes historical tool transcript state, Requirement: Compaction thresholds reflect provider-visible context growth (+15 more)
...
Cohesion: 0.13
Nodes (18): estimate_bundle_size(), handoff_includes_skill_state_in_size_estimate(), handoff_preserves_activated_skills(), HandoffBundle, HandoffBundleMetadata, HandoffExporter, HandoffImporter, hydrate_in_place_does_not_modify_plugin_enablement() (+10 more)
...
Cohesion: 0.09
Nodes (5): CompactedContext, Decision, PortabilityNote, UnresolvedQuestion, portability_note_portable()
...
Cohesion: 0.1
Nodes (12): convert_notification_to_prompt_event_with_index(), FacadeClientChannel, PermissionRequest, PermissionVerdict, PromptEvent, PromptEvents, PromptOutcome, PromptStatus (+4 more)
...
Cohesion: 0.18
Nodes (16): compaction_execute_calls_provider_and_parses_result(), compaction_execute_handles_empty_output(), compaction_execute_handles_malformed_json(), compaction_execute_handles_provider_error(), facade_checkpoint_rejects_disabled_context_management(), facade_checkpoint_rejects_non_idle_session(), facade_checkpoint_triggers_compaction(), facade_create_session_from_handoff() (+8 more)

### Community 53 - "Community 53"
Cohesion: 0.17
Nodes (16): create_transport_client(), HttpResponseIdMode, read_http_request_with_body(), start_bootstrap_tolerance_http_server(), start_header_capture_http_server(), start_streamable_http_server(), test_http_mcp_client_initialize_accepts_absent_response_id(), test_http_mcp_client_initialize_accepts_explicit_null_response_id() (+8 more)
...
Cohesion: 0.12
Nodes (18): Monty Embedded Python Runtime, ToolRegistry, Bootstrap-Only ID Tolerance, Fix MCP CamelCase Protocol Fields Change, Expose Python Tool Methods (Change), Handoff Portability Model, Improve Python Exec Guidance (Change), iron_call(name, args) Function (+10 more)

### Community 56 - "Community 56"
Cohesion: 0.12
Nodes (14): CompactionCheckpoint, CompactionEngine, CompactionInput, CompactionReason, estimate_structured_tokens(), extract_json_object(), older_provider_messages(), try_extract_balanced_braces() (+6 more)
...
Cohesion: 0.18
Nodes (20): ApprovalStrategy, compute_tool_availability, EffectiveToolView, Embedded Python Runtime, Finish MCP Outstanding Work - Design, Finish MCP Outstanding Work - Python Tool Namespace Spec, Finish MCP Outstanding Work - Session Scoped MCP Support Spec, Fully Operational MCP - Design (+12 more)

### Community 61 - "Community 61"
Cohesion: 0.22
Nodes (14): accepts_existing_path_inside_root(), accepts_nested_nonexistent_path_inside_root(), accepts_nonexistent_file_inside_root(), ApprovalDuration, ApprovalScope, ApprovalScopeMatch, BuiltinToolPolicy, canonicalize_by_ancestor() (+6 more)
...
Cohesion: 0.13
Nodes (17): CompactedContext Struct, ContextWindowPolicy, activate_skill Model Tool, Agent Skills, agent-skills Capability, Agent Skills Support Change, Compacted Context + Retained Tail Prompt Model, Context Compaction Capability (+9 more)
...
Cohesion: 0.17
Nodes (16): Per-Prompt Credential Resolver, App-Owned Credential Store Abstraction, iron-core README, iron-providers Credential Types, Managed Provider Execution Path, MCP HTTP Headers, Safe OAuth Auth Failure Retry, OAuth Device Code Token Exchange (+8 more)
...
Cohesion: 0.26
Nodes (10): cancel_running_leaves_no_running_records_after(), cancel_running_skips_already_terminal_records(), cancel_running_transitions_running_and_pending(), cancel_running_with_no_running_is_noop(), DurableToolRecord, estimate_text_tokens(), estimate_tool_call_tokens(), fresh_session() (+2 more)
...
Cohesion: 0.17
Nodes (4): ApprovalStrategy, ConfigSource, ContextWindowPolicy, PluginConfig

### Community 103 - "Community 103"
Cohesion: 0.24
Nodes (6): render_mutation_summary(), render_path(), render_skip_warning(), render_truncation_footer(), render_glob_output(), render_grep_output()

### Community 104 - "Community 104"
Cohesion: 0.2
Nodes (8): ActiveContextAccountant, ActiveContextSnapshot, ContextCategory, ContextCategoryUsage, ContextQuality, ContextTelemetry, estimate_tokens(), telemetry_estimate_messages_tokens()

### Community 105 - "Community 105"
Cohesion: 0.24
Nodes (10): compaction_prepare_extracts_tail_and_builds_prompt(), compaction_prepare_includes_historical_tool_transcript(), compaction_prepare_with_existing_context_includes_previous(), compaction_split_session_messages_rule(), compaction_split_session_policy_rule(), compaction_split_session_small_session(), compaction_split_session_tokens_rule(), durable_session_apply_compaction_resets_uncompacted_tokens() (+2 more)
...
Cohesion: 0.29
Nodes (3): apply_headers(), format_rpc_error(), HttpSseMcpClient
...
Cohesion: 0.2
Nodes (7): ADDED Requirements, Requirement: MCP state is excluded from handoff portability, Requirement: Runtime-local MCP server inventory, Scenario: Client lists configured runtime MCP servers, Scenario: Destination runtime decides its own MCP availability, Scenario: Handoff does not carry enabled MCP servers, Scenario: Runtime inventory is local to the current runtime

### Community 128 - "Community 128"
Cohesion: 0.2
Nodes (9): Purpose, Requirement: Public MCP helper APIs must not advertise stub execution behavior, Requirement: Session-scoped MCP enablement, Requirements, Scenario: New session uses runtime default enablement, Scenario: Public MCP helper cannot report fake execution success, Scenario: Runtime default applies uniformly across configured servers, Scenario: Session toggle does not affect another session (+1 more)
...
Cohesion: 0.22
Nodes (7): ADDED Requirements, Requirement: Baseline prompt guidance SHALL promote efficient built-in tool usage, Requirement: Search tools SHALL tolerate partial traversal failures, Scenario: Prompt instructs the model to batch independent work, Scenario: Prompt instructs the model to keep responses terse, Scenario: Search continues after minor unreadable paths, Scenario: Significant skipped-path conditions can be surfaced

### Community 142 - "Community 142"
Cohesion: 0.25
Nodes (3): BuiltinMeta, meta_continuation_includes_offset(), meta_truncation_includes_fields()
...
Cohesion: 0.38
Nodes (5): fail_pending_waiters(), is_acceptable_bootstrap_response(), redact_command(), start_stdio_stderr_reader(), start_stdio_stdout_reader()
...
Cohesion: 0.4
Nodes (3): ShellAvailability, which_exists(), shell_availability_detect_runs_without_panic()

### Community 199 - "Community 199"
Cohesion: 0.4
Nodes (4): test_end_to_end_mcp_lifecycle(), test_mcp_tools_have_namespaced_names(), stdio_post_bootstrap_id_less_response_is_rejected(), write_stdio_server_null_id_on_tools_list()
...
Cohesion: 0.67
Nodes (3): Requirement: Built-in tool descriptions SHALL teach efficient tool usage, Scenario: Read and edit tools describe bounded efficient workflows, Scenario: Search tools describe batching and selection guidance
...
## Knowledge Gaps
- **1035 isolated node(s):** `Run the build and lint checks with a terse summary.`, `Run the test suite with a terse summary.`, `Run security checks with a terse summary.`, `CapabilityDescriptor`, `CapabilityBackend` (+1030 more)
...
- **Why does `iron-providers Dependency` connect `Community 106` to `Community 0`, `Community 34`, `Community 100`, `Community 5`, `Community 6`, `Community 10`, `Community 76`, `Community 83`, `Community 147`, `Community 53`, `Community 56`, `Community 95`, `Community 31`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `SessionToolCatalog` connect `Community 60` to `Community 93`, `Community 14`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `compute_tool_availability` connect `Community 60` to `Community 1`, `Community 3`?**
