# Graph Report - iron-core  (2026-05-13)

## Corpus Check
- 209 files · ~186,425 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3616 nodes · 5681 edges · 238 communities (201 shown, 37 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 339 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `23c62266`
...
- `unit_schema_validate_bad_schema()` --calls--> `validate_arguments()`  [INFERRED]
  tests/acp_runtime_tests.rs → src/schema.rs
- `keep_recent_parity_between_legacy_and_acp()` --calls--> `build_inference_request()`  [INFERRED]
  tests/acp_runtime_tests.rs → src/request_builder.rs
- `request_builder_composes_instructions()` --calls--> `build_inference_request()`  [INFERRED]
  tests/prompt_composition_tests.rs → src/request_builder.rs
...
## Communities (238 total, 37 thin omitted)
...
Cohesion: 0.06
Nodes (22): PythonExecTool, script_output_to_json(), agent_text(), AuthFailProvider, limit_result_size(), make_session_and_ephemeral(), managed_does_not_retry_api_key_backed_auth_failure(), managed_does_not_retry_stream_auth_failure_after_output() (+14 more)
...
Cohesion: 0.08
Nodes (41): codex_expires_at_to_secs(), codex_test_metadata(), CodexAuthorizationResponse, CodexDeviceAuthState, decode_base64_url(), DeviceCodeInteraction, DeviceCodeResponse, DeviceCodeStartResult (+33 more)
...
Cohesion: 0.07
Nodes (41): iron-providers Dependency, create_transport_client(), ConnectionId, cancel_active_prompt_signals_cancellation(), close_session_removes_only_that_session(), closing_connection_removes_its_sessions(), create_session_on_shutdown_errors(), has_active_prompt_reflects_prompt_lifecycle() (+33 more)
...
Cohesion: 0.09
Nodes (13): crate::error::RuntimeError, EditTool, execute_read(), execute_write(), is_binary(), MultieditTool, ReadTool, render_directory_listing() (+5 more)
...
Cohesion: 0.13
Nodes (26): concurrent_sse_requests_are_correctly_correlated(), connection_manager_stops_on_shutdown_signal(), FakeSseServer, http_sse_transport_handles_framing_and_response_correlation(), mcp_name_resolution_is_unambiguous_for_server_ids_with_underscores(), public_effective_tools_match_prompt_visible_tools(), read_http_request(), RecordingProvider (+18 more)
...
Cohesion: 0.15
Nodes (19): compaction_execute_calls_provider_and_parses_result(), compaction_execute_handles_empty_output(), compaction_execute_handles_malformed_json(), compaction_execute_handles_provider_error(), compaction_prepare_extracts_tail_and_builds_prompt(), compaction_prepare_includes_historical_tool_transcript(), facade_checkpoint_rejects_disabled_context_management(), facade_checkpoint_rejects_non_idle_session() (+11 more)
...
Cohesion: 0.15
Nodes (4): ClientChannel, IronConnection, NopClientChannel, notification()
...
Cohesion: 0.11
Nodes (18): CompactionCheckpoint, CompactionInput, CompactionReason, estimate_structured_tokens(), extract_json_object(), older_provider_messages(), try_extract_balanced_braces(), compaction_prepare_with_existing_context_includes_previous() (+10 more)
...
Cohesion: 0.16
Nodes (14): estimate_bundle_size(), handoff_includes_skill_state_in_size_estimate(), handoff_preserves_activated_skills(), HandoffBundle, HandoffBundleMetadata, HandoffExporter, HandoffImporter, hydrate_in_place_does_not_modify_plugin_enablement() (+6 more)
...
Cohesion: 0.22
Nodes (5): BuiltinToolError, execute_edit(), execute_multiedit(), read_to_string(), execute_webfetch()
...
Cohesion: 0.2
Nodes (7): to_acp_content_block(), AcpPromptSink, ApprovalRequest, ApprovalVerdict, PromptLifecycleEvent, PromptSink, ToolUpdateStatus
...
Cohesion: 0.2
Nodes (7): CompactionEngine, compaction_build_input_includes_previous_context(), compaction_build_input_without_previous(), compaction_parse_compacted_context_invalid_json(), compaction_parse_compacted_context_valid_json(), compaction_parse_compacted_context_wrapped_in_code_block(), compaction_reconstruct_messages_includes_summary_and_tail()
...
## Knowledge Gaps
- **1042 isolated node(s):** `Run the build and lint checks with a terse summary.`, `Run the test suite with a terse summary.`, `Run security checks with a terse summary.`, `CapabilityDescriptor`, `CapabilityBackend` (+1037 more)
...
- **Why does `compute_tool_availability` connect `Community 59` to `Community 1`, `Community 4`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `iron-providers Dependency` connect `Community 12` to `Community 0`, `Community 2`, `Community 6`, `Community 104`, `Community 11`, `Community 77`, `Community 141`, `Community 51`, `Community 118`, `Community 24`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `SessionToolCatalog` connect `Community 59` to `Community 16`, `Community 90`?**
