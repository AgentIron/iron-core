# mcp-http-headers Specification

## Purpose

This specification defines HTTP header support for MCP remote transports, including a required Accept header and user-configurable custom headers via a shared HttpConfig struct.
## Requirements
